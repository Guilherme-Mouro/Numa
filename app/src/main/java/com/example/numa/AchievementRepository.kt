    ...
    suspend fun initializeAchievements() {
        val achievements = listOf(
            ...
            Achievement(
                ...
                level = 7,
                title = "Comprometido",
                description = "Completar mesmo hábito 7 dias seguidos",
                points = 60,
                experience = 30,
            ),
            Achievement(
                ...
                level = 30,
                title = "Disciplinado",
                description = "Completar mesmo hábito 30 dias seguidos",
                points = 150,
                experience = 75,
            ),
            Achievement(
                ...
                description = "Completar mesmo hábito 60 dias seguidos",
                points = 300,
                experience = 150,
            ),
            Achievement(
                ...
                description = "Completar mesmo hábito 100 dias seguidos",
                points = 500,
                experience = 250,
            ),
            Achievement(
                ...
                level = 365,
                title = "Imortal",
                description = "Completar mesmo hábito 365 dias seguidos",
                points = 1000,
                experience = 500,
            ),
